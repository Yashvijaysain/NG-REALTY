    ...
    <div className="min-h-screen bg-[#f6f1e8] text-[#0b1114] font-sans overflow-x-hidden relative selection:bg-[#ead39a]">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-36 md:pt-48 pb-16 text-center">
        ...
        >
          ...
          <h1 className="font-serif text-[42px] md:text-[76px] leading-[2.05] tracking-tight font-bold mb-14 text-[#0b1114]" style={{ color: "var(--ink)" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 pb-12 border-b border-white/10">
            ...
            <div className="col-span-2 flex flex-col justify-between gap-6">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-white transition-colors" aria-label="LinkedIn">
                ...
                <a href="https://www.instagram.com/next_gen_realty/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-white transition-colors" aria-label="Instagram">
